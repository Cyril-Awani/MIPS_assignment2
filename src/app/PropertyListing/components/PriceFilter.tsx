	...
	return (
		<div
			...
			<div
				...
				<p className='text-md font-semibold'>Price Range</p>
				<IoIosArrowDown
					style={{
						fontSize: 15,
						stroke: 'currentColor',
			...
			{/* Dropdown Menu */}
			{isDropdownOpen && (
				<div className='absolute right-0 md:left-0 top-full mt-2 bg-white border border-gray-200 rounded-lg shadow-lg z-10 w-[1000px] max-w-sm'>
					<Box sx={{ padding: '16px' }}>
